...
impl Query {
    ...
    fn build_info_packet(&self, mut packet: Cursor<Vec<u8>>) -> Result<String> {
        ...
        serde_json::to_string(&data).map_err(|e| LauncherError::SerdeJson(e.to_string()))
    }
    ...
    fn build_players_packet(&self, mut packet: Cursor<Vec<u8>>) -> Result<String> {
        ...
        serde_json::to_string(&players).map_err(|e| LauncherError::SerdeJson(e.to_string()))
    }
    ...
    fn build_rules_packet(&self, mut packet: Cursor<Vec<u8>>) -> Result<String> {
        ...
        serde_json::to_string(&rules).map_err(|e| LauncherError::SerdeJson(e.to_string()))
    }
}
